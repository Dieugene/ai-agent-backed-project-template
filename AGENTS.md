...
- **Запускается:** При обсуждении архитектуры, создании задач, приемке работ
- **Задача:** Ведет backlog, принимает архитектурные решения (ADR), создает постановки задач
...
**⚠️ Важно:** Обе папки `03_data/` и `04_logs/` **версионируются в git**. Они не в .gitignore!
