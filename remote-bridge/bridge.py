...
Пишет ТОЛЬКО доверенный владелец в личку (модель доверия инвертирована vs team-live,
...
цели (не «недоверенный ввод», как в team-live). Сам движок текст не интерпретирует —
