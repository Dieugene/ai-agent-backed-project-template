...
> ⚠️ `.launcher/` в путях ниже — **имя папки супервайзора в исходном воркспейсе**, а не требование.
> Если у вас такая папка уже есть под другим именем — используйте её и подставьте своё имя во все пути;
> вторая папка раздвоит точку входа ролей. Порядок решений — вводный блок корневого README.
